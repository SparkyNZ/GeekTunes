...
- (void)drawInContext:(CGContextRef)context
{
  ...
  */
	[[UIColor colorWithWhite:0.45 alpha:1.0] set]; // .2 & .4
	[self.self.offString drawAtPoint:CGPointMake(offTextPoint.x, offTextPoint.y - 1.0) withFont:self.labelFont];
  
	[[UIColor whiteColor] set];
	[self.self.offString drawAtPoint:offTextPoint withFont:self.labelFont];
